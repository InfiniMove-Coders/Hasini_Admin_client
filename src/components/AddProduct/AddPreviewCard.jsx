	...
	return (
		<div className="w-[25%] border-[black] border-[0px] flex flex-col items-center justify-start gap-[15px] sticky top-[50px]">
			...
			<div className="w-full h-auto bg-white rounded-[6px] p-[10px] flex flex-col items-start justify-start border-[#D9D9D9] border-[2px] gap-[5px]">
				...
				<p className="text-[#686363]">{formik.values.Units_Box ? formik.values.Units_Box : "XX"} Pcs/Box, {formik.values.Box_Carton ? formik.values.Box_Carton : "XX"} Box/Carton</p>
				<div className="w-full h-auto flex flex-row items-center justify-between">
					<div className="w-auto h-auto flex flex-row items-center justify-between gap-[10px]">
						<p className="text-[#686363] line-through">&#x20B9;{formik.values.Price ? formik.values.Price : "XXX"}</p>
				...
				<div className="w-auto h-auto flex flex-row items-center justify-between gap-[10px]">
					<p className="text-[160%] font-bold text-[#262626]">&#x20B9;{formik.values.OfferPrice ? formik.values.OfferPrice : "XX"}</p>
					<p className="font-bold opacity-[90%] scale-[90%]">@&#x20B9;{formik.values.UnitPrice ? formik.values.UnitPrice : "XX"}-per piece</p>
				</div>
